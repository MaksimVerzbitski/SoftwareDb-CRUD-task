...
namespace SoftwareDb
{
    class Utility
    {
        ...
        public static bool ValidateInput<T>(string inputMessage, string errorMessage, Func<string, T> parser, out T outer)
        {
        ...
        public static bool ValidateString(string r) {
